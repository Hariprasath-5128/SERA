...
**Generated:** 20260904_024953
**Generator Model:** `llama3:8b`
**Judge Model:** `qwen2.5:7b`
**Experiment scope:** `additional_info`  |  **Query types:** `all`
...
|-------------|----------|-----------|-----------|
| s1_d3 | 1 | 3 | ~1 raw-chunk token budget matched to 3 super-node budget |
| s2_d6 | 2 | 6 | ~2 raw-chunk token budget matched to 6 super-node budget |
| s3_d9 | 3 | 9 | ~3 raw-chunk token budget matched to 9 super-node budget |
...
|------------|----------|----------|----------|-----------------|---------------|
| Simple | Static | 53.1% | 36.8% | 0.0 | 0.0 |
| Simple | Dynamic | 50.5% | 35.2% | 0.0 | 0.0 |
| Complex | Static | 38.8% | 39.2% | 0.0 | 0.0 |
| Complex | Dynamic | 41.0% | 33.5% | 0.0 | 0.0 |
...
2. **BioBERT F1** is approximated as sentence-embedding cosine similarity rather than token-level BERTScore (cheaper but less precise).
...
*Report generated automatically by `scripts/eval_static_vs_dynamic.py` at 20260904_024953.*