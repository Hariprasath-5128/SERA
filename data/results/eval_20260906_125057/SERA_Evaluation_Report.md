...
|-------------|----------|-----------|-----------|
| s2_d1 | 2 | 1 | ~2 raw-chunk token budget matched to 1 super-node budget |
| s4_d2 | 4 | 2 | ~4 raw-chunk token budget matched to 2 super-node budget |
| s9_d4 | 9 | 4 | ~9 raw-chunk token budget matched to 4 super-node budget |

### Simple Queries - Budget Results

| Config | ROUGE-L F1 | BioBERT F1 | Concept Recall | RAIV | Ctx Tokens | Out Tokens | Total Tokens | Latency | SAIR | UAIR |
|--------|-----------|-----------|---------------|------| -----------|-----------|-------------|---------|------|------|
| s2_d1 (Static, k=s2) | 0.1097 | 0.7245 | 0.0859 | 33.4 | 364 | 105 | 469 | 22.525s | 0.0% | 0.0% |
| s2_d1 (Dynamic, k=d1) | 0.1142 | 0.7205 | 0.0922 | 39.7 | 371 | 110 | 481 | 21.282s | 0.0% | 0.0% |
| s4_d2 (Static, k=s4) | 0.1286 | 0.7278 | 0.1085 | 49.2 | 728 | 137 | 865 | 29.017s | 0.0% | 0.0% |
| s4_d2 (Dynamic, k=d2) | 0.1212 | 0.7419 | 0.1003 | 50.0 | 625 | 122 | 747 | 25.584s | 0.0% | 0.0% |
| s9_d4 (Static, k=s9) | 0.1445 | 0.7273 | 0.1254 | 68.0 | 1591 | 179 | 1770 | 46.231s | 0.0% | 0.0% |
| s9_d4 (Dynamic, k=d4) | 0.1207 | 0.7567 | 0.0989 | 66.4 | 1200 | 114 | 1315 | 28.036s | 0.0% | 0.0% |

### Complex Queries - Budget Results

| Config | ROUGE-L F1 | BioBERT F1 | Concept Recall | RAIV | Ctx Tokens | Out Tokens | Total Tokens | Latency | SAIR | UAIR |
|--------|-----------|-----------|---------------|------| -----------|-----------|-------------|---------|------|------|
| s2_d1 (Static, k=s2) | 0.1499 | 0.7471 | 0.1214 | 26.8 | 359 | 140 | 498 | 31.986s | 0.0% | 0.0% |
| s2_d1 (Dynamic, k=d1) | 0.1398 | 0.6659 | 0.1191 | 30.3 | 379 | 129 | 507 | 28.870s | 0.0% | 0.0% |
| s4_d2 (Static, k=s4) | 0.1618 | 0.7307 | 0.1384 | 38.6 | 699 | 184 | 882 | 51.741s | 0.0% | 0.0% |
| s4_d2 (Dynamic, k=d2) | 0.1635 | 0.7447 | 0.1383 | 43.6 | 707 | 169 | 875 | 39.048s | 0.0% | 0.0% |
| s9_d4 (Static, k=s9) | 0.1733 | 0.7299 | 0.1546 | 53.7 | 1521 | 226 | 1747 | 56.073s | 0.0% | 0.0% |
| s9_d4 (Dynamic, k=d4) | 0.1768 | 0.7350 | 0.1575 | 59.1 | 1309 | 203 | 1512 | 50.515s | 0.0% | 0.0% |
...
*Report generated automatically by `scripts/eval_static_vs_dynamic.py` at 20260906_125057.*